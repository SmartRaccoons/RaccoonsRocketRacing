...
(function() {
  ...
  App.Router = Router = (function(_super) {
    ...
    Router.prototype.initialize = function(op) {
      ...
      this.listenTo(this.room, 'open', (function(_this) {
        return function(id) {
          return _this.map(id);
        };
      })(this));
      this.room_new = new App.CreateRoom();
      this.listenTo(this.room_new, 'create', (function(_this) {
        return function() {
      ...
      this.game.render();
      this.listenTo(App.socket.receive, 'login:success', (function(_this) {
        return function(user) {
          _this.user = user;
          return _this.room.options.monitor = user.id;
        };
      })(this));
      this.listenTo(App.socket.receive, 'room:list', (function(_this) {
        return function() {
          _this.game.stop();
          return _this.$el.removeClass('user-in-room');
        };
      })(this));
      this.listenTo(App.socket.receive, 'game:start', (function(_this) {
        return function() {
          return _this.$el.addClass('user-in-room');
        };
      })(this));
      this.listenTo(App.socket.receive, 'roompreview:show', (function(_this) {
        return function(data) {
          return _this.navigate('m' + data.id);
        };
      })(this));
      o = new Order();
      this.listenTo(App.socket.receive, 'all', (function(_this) {
        return function() {
          var args, delay, event, params, _ref;
          args = Array.prototype.slice.call(arguments);
          event = args.shift();
          params = event.split(':');
          if (params.length === 2) {
            if ((_ref = params[0]) === 'room' || _ref === 'roompreview' || _ref === 'game') {
              delay = 0;
