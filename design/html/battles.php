				<div class="c">
					...
					<div class="l" id="map-list">
						<ol class="t"><?php
							for($i=0;$i<=10;$i++) {?>

							<li class="map">
								<ul class="c">
									<li class="l w49 name">Super mapka</li>
									<li class="l w15 m users">5/10</li>
									<li class="r w33 stage">Stage 1</li>
								</ul>
							</li><?php
							}?>
